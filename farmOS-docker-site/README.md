...
| `farmos_release_version`      | farmOS version to be used. This queries for the latest available farmOS version and presents it to you as the default value.                         | **3.3.3**                     |
